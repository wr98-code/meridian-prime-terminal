/**
 * Security.tsx — ZERØ MERIDIAN 2026 push133
...
const RISK_COLORS = Object.freeze({
  LOW:      'rgba(0,155,95,1)',
  MEDIUM:   'rgba(195,125,0,1)',
  HIGH:     'rgba(255,140,0,1)',
  CRITICAL: 'rgba(208,35,75,1)',
});
...
const ScoreRing = memo(({ score, level }: { score: number; level: TokenSecurityResult['riskLevel'] }) => {
  ...
  return (
    <svg width={56} height={56} style={{ flexShrink: 0 }}>
      <circle cx={28} cy={28} r={r} fill="none" stroke="rgba(15,40,100,0.08)" strokeWidth={4} />
      <circle
        cx={28} cy={28} r={r}
        fill="none"
        stroke={col}
          ...
          >
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 8, marginTop: 12 }}>
              {[
                ...
                <div key={item.label} style={{ background: 'rgba(15,40,100,0.04)', borderRadius: 6, padding: '8px 10px' }}>
